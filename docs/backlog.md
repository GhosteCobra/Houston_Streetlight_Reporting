...
| PLAN-08 | 4 | Location, report and status APIs | PLAN-03, PLAN-06 | Contract errors, retries, no live provider calls |
...
Current milestone: PLAN-03 sample pole contract/data, PLAN-02 web bootstrap, then PLAN-04 interactive map and selection. Review map behavior before adding the camera/report persistence flow.
