...
**Owner:** Person 1; Person 5 prepares the environment. Planned duration: 3–5 minutes.
...
Prepare a no-photo fallback, denied-location example, and a sample dataset reset in the isolated demo environment. Do not depend on unapproved live data or live provider submission. Record the tested URL/commit and known gaps before presenting. Photos cannot by themselves prove every fault or guarantee a repair.
