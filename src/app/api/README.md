...
Future route.ts modules following docs/api-contract.md.

## Working rules

Authenticate and validate every write, authorize record access, and keep secrets server-only. No routes are implemented here yet.
